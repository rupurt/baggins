# Clinical Coding Extraction - Product Requirements

## Problem Statement

How does Mission Two guarantee deterministic coding outputs from normalized intake evidence with auditable provenance?
...
- [SCOPE-01] Normalize evidence tokens into candidate coding payloads.
- [SCOPE-02] Attach deterministic lineage and confidence metadata for every candidate.

### Out of Scope

- [SCOPE-03] Payer-specific code override workflows.
- [SCOPE-04] Final claim submission or payer adjudication.
